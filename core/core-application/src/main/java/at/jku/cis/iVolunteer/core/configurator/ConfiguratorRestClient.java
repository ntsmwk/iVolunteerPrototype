package at.jku.cis.iVolunteer.core.configurator;
...
public class ConfiguratorRestClient {
    ...
    @Value("${configurator.uri}")
    private String url;

    public HttpStatus initConfigurator(InitConfiguratorRequest body, String key) {
        ResponseEntity<Object> resp = restTemplate.exchange(url + "/init/configurator/" + key, HttpMethod.PUT,
                buildEntity(body), Object.class);
