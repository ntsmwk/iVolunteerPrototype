...
import { BrowseMatchingSubDialogModule } from 'app/main/content/_components/help-seeker/configuration/matching-configurator/_dialogs/browse-sub-dialog/browse-sub-dialog.module';
