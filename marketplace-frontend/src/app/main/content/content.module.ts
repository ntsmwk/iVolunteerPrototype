...
const routes: Route[] = [
  ...
  // ##### added
  {
    path: 'main/bcEntry-form',
    loadChildren: './bcEntry-form/bcEntry-form.module#FuseBCEntryFormModule',
    canActivate: [TokenGuard, AdminGuard]
  },
  {
    path: 'main/bcEntries/all',
    loadChildren: './bcEntry-list/bcEntry-list.module#FuseBCEntryListModule',
    canActivate: [TokenGuard, AdminGuard]
  },
  // ####
  {
