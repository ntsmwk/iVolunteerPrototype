...
} from "app/main/content/_components/help-seeker/configuration/property-enum-configurator/builder/enum/enum-graph-editor/open-enum-definition-dialog/open-enum-definition-dialog.component";
