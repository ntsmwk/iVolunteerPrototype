...
@Injectable({
  ...
  export class ClassInstanceService {
    ...
    getClassInstanceById(marketplace: Marketplace, classInstanceId: String, tenantId: String) {
      return this.http.get(`${marketplace.url}/meta/core/class/instance/by-id/${classInstanceId}/tenant/${tenantId}`);
    }
