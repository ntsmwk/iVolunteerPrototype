...
public class XClassInstanceToTaskCertificateMapper implements OneWayMapper<ClassInstance, XTaskCertificate> {
	...
	@Autowired XClassInstanceToTaskSerializedMapper classInstanceToTaskSerializedMapper;
	@Autowired XTenantToTenantSerializedMapper tenantToTenantSerializedMapper;
	@Autowired CoreTenantRestClient tenantRestClient;
	@Autowired UserController userController;
	@Autowired XUserMapper userMapper;
