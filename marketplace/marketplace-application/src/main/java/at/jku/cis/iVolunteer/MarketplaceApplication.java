...
//		createCompetenceClassDefinition();
	}

	private void createCompetenceClassDefinition() {
		ClassDefinition definition = new ClassDefinition();
		definition.setArchetype(ClassArchetype.COMPETENCE);
		definition.setName("mycomp");
		definition.setRoot(true);
		
		classDefinitionRepository.save(definition);
			}
...
//	}
	...
	private void addStandardPropertyDefinitions() {
		StandardPropertyDefinitions spd = new StandardPropertyDefinitions(competenceRepository,
	...
	private void addTestTemplates() {
		...
		StandardTemplates st = new StandardTemplates(competenceRepository, propertyDefinitionRepository,
				propertyDefinitionToClassPropertyMapper);
...
//		  {from: 6, to: 6},
		...
		i5.setId("test_i5");
		Association i6 = new Association(c6.getId(), c6.getId(), AssociationCardinality.ONE,
				AssociationCardinality.ZEROSTAR);
		i6.setId("test_i6");

		Association i7 = new Association(c5.getId(), c7.getId(), AssociationCardinality.ONE,
				AssociationCardinality.ONESTAR);
		i7.setId("test_i7");
		Association i8 = new Association(c5.getId(), c8.getId(), AssociationCardinality.ONE,
				AssociationCardinality.ZEROONE);
		i8.setId("test_i8");
		Association i9 = new Association(c4.getId(), c9.getId(), AssociationCardinality.ZEROSTAR,
				AssociationCardinality.ZEROONE);
		i9.setId("test_i9");
	...
	private void addFlexProdConfigClasses() {
		...
		oteAllgemein.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("maxgluehtemperatur")));
		oteAllgemein.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("verfuegbaresschutzgas")));
		oteAllgemein.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("bauart")));
		oteAllgemein.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("temperaturhomogenitaet")));
		oteAllgemein.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("kaltgewalztesmaterialzulaessig")));
		oteAllgemein.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("warmgewalztesmaterialzulaessig")));
		...
		oteMoeglicheVorbehandlung.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("bundentfetten")));
		...
		otecKonvektoren.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		otecKonvektoren.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		otecKonvektoren.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("hoehe")));
		...
		otecTragerahmen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		otecTragerahmen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		otecTragerahmen.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("hoehe")));
		...
		otecZwischenrahmen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		otecZwischenrahmen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		otecZwischenrahmen.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("hoehe")));
		...
		otecKronenstoecke.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		otecKronenstoecke.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		otecKronenstoecke.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("hoehe")));
		...
		otecChargierkoerbe.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		otecChargierkoerbe.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		otecChargierkoerbe.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("hoehe")));
		...
		ofenBetrieblicheEigenschaften.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("gluehzeit")));
		ofenBetrieblicheEigenschaften.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("durchsatz")));
		...
		ogeBaugroesse.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("moeglicheinnendurchmesser")));
		ogeBaugroesse.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("maxaussendurchmesser")));
		ogeBaugroesse.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("maxchargierhoehe")));
		...
		oqeQualitätsnormen.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("cqi9")));
		oqeQualitätsnormen.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("tus")));
		...
		oqeWartungen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("letztewartung")));
		oqeWartungen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("wartungsintervall")));
		...
		ingeBundabmessungen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		ingeBundabmessungen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		ingeBundabmessungen.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("bandbreite")));
		ingeBundabmessungen.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("bandstaerke")));
		...
		inqeMaterialart.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("warmgewalzt")));
		inqeMaterialart.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("kaltgewalzt")));
		...
		outteMechanischeEigenschaften.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("streckgrenze")));
		outteMechanischeEigenschaften.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("zugfestigkeit")));
		outteMechanischeEigenschaften.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("dehnung")));
		...
		outteGefuege.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("gefuege")));
		...
		outgeMoeglicheBundabmessungen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("aussendurchmesser")));
		outgeMoeglicheBundabmessungen.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("innendurchmesser")));
		outgeMoeglicheBundabmessungen.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("bandbreite")));
		outgeMoeglicheBundabmessungen.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("bandstaerke")));
		...
		outqeMaterialart.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("warmgewalzt")));
		outqeMaterialart.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("kaltgewalzt")));
		...
		logistischeBeschreibung.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("materialbereitgestellt")));
		logistischeBeschreibung.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("lieferort")));
		logistischeBeschreibung.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("verpackung")));
		logistischeBeschreibung.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("transportart")));
		logistischeBeschreibung.getProperties()
				.add(propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("menge")));
		logistischeBeschreibung.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("lieferdatum")));
		logistischeBeschreibung.getProperties().add(
				propertyDefinitionToClassPropertyMapper.toTarget(propertyDefinitionRepository.findOne("incoterms")));
		...
		preislicheBeschreibung.getProperties().add(propertyDefinitionToClassPropertyMapper
				.toTarget(propertyDefinitionRepository.findOne("zahlungsbedingungen")));
